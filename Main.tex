...
\begin{figure}[h!]
  ...
  \begin{minipage}[b]{0.5\linewidth}
    ...
    \subcaption{}
  \end{minipage}
  \caption{Measurement output power of the \SI{976}{nm} fiber amplifier and results of the simulation.}
...
We achieved \SI{6.7}{W} of \SI{976}{nm} at maximum pump power of \SI{68}{W} which is corresponding to \SI{14.5}{dB}, but the output decays with time and was reduced by about 10\% or more of its original power after 60 minutes.
This is likely due to photodarkening caused by the high inversion distribution of Yb ion.
