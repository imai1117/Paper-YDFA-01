...
\begin{figure}[h!]
\centering\includegraphics[width=12cm]{./Figure/976nmYDFASystem.eps}
...
The seed and pump are combined to a double cladding PM fiber which has core of \SI{20}{\micro m} and cladding of \SI{125}{\micro m} by a pump and signal combiner.
The \SI{915}{nm} radiation for pumping the Yb dope fiber is generated from fiber-coupled laser diode with an output power of up to \SI{70}{W}.
The output is directly fusion-spliced to a port of the pump and signal combiner.
