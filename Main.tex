...
The seed input of the YDFA is connected to an isolator and wavelength divison multiplexing(WDM) filter, which are used to block return light such as backward ASE to the seed laser.
The seed and pump light are combined to a double cladding PM fiber which has core of \SI{20}{\micro m} and cladding of \SI{125}{\micro m} by pump and signal combiner.
The Pump light is generated
...
\begin{figure}[h!]
\centering\includegraphics[width=7cm]{./Figure/osafig1.pdf}
